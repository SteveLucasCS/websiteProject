...
<?php
$mailto = "lucasst@mail.gvsu.edu,kautzc@gvsu.edu";//Enter your email address here, separated by commas. Replace student-name@mail.gvsu.edu placeholders with the actual email address. Be sure to include the instructor's email too.
